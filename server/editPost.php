...
if($_SERVER['REQUEST_METHOD']== 'POST'){
    ...
    elseif (empty($_POST['category'])){
        ...
        if($checkTitle){
            ...
            $out['success'] = true;
            $currentId = $_GET['id'];
            $obj->execute("UPDATE posts SET title = '$title',annotation = '$annotation',content = '$content',email = '$email',views = $views,date = '$date',publish_in_index = $publish_in_index,category_id = '$category' WHERE id = $currentId");
        }
    }
}
